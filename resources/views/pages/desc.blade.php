...
<head>
  ...
  <title>Black Bag (2025) - Watchverse</title>
  <style>
    * {
      margin: 0;
      padding: 0;
    ...
    /* Main Container */
    .main-container {
      position: relative; /* Changed to relative to contain the overlay */
      padding: 2rem 4rem;
      min-height: 100vh;
    }
    ...
    /* Background Image */
    .background-image {
      position: absolute; /* Changed to absolute to stay within main-container */
      top: 0;
      left: 0;
      width: 100%;
      height: 100%;
    ...
    .where-to-watch-section {
      margin-top: 2.2rem;
      margin-bottom: 2rem; /* Added to ensure space before footer */
    }
    ...
    /* Footer */
    footer {
      background-color: #2D283E; /* Match the body background */
      color: #D1D7E0;
      padding: 5rem 1.5rem;
      margin-top: 5rem;
    }
    ...
    footer .max-w-6xl > div:first-child {
      align-items: center;
    }

    footer .max-w-6xl img {
      height: 1.5rem;
      margin-bottom: 0.5rem;
    }

    footer .max-w-6xl p.text-sm {
      font-size: 0.875rem;
      margin-top: 0.5rem;
      line-height: 1.5;
    }
    ...
    footer .max-w-6xl .flex a {
      color: #D1D7E0;
      transition: color 0.3s ease;
    }

    footer .max-w-6xl .flex a:hover {
      color: #802BB1;
    }
...
<body>
  ...
  <footer>
    <div class="max-w-6xl">
      <div>
        <img src="{{ asset('watchverse.svg') }}" alt="Watchverse Logo">
        <p class="text-sm">Your watchlist, organized and personalized!</p>
        <div class="flex">
    ...
    <p class="text-center">© 2025 Watchverse. All rights reserved.</p>
  </footer>
